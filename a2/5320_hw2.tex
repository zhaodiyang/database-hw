...
\\
(c) Use the file scan.\\
We need to scan almost all the pages. Even though we use the tree or hash find the 21600 and 21800, we still need to scan all of the pages. So it is better to scan pages directly.\\
\\
(d) Use the file scan.\\
